...
export default function Footer() {
    ...
    async function getVisitorCount() {
        ...
        let visitorCountResult = await axios.get(`https://api.loglib.io/v1/inisght?apiKey=site_1q86oqrcwj&startDate=2023-08-10&endDate=${formattedDate}&timeZone=Africa/Addis_Ababa`);
